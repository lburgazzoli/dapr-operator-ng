...
import (
	...
	daprvApi "github.com/lburgazzoli/dapr-operator-ng/api/tools/v1alpha1"
...
//+kubebuilder:rbac:groups=tools.dapr.io,resources=daprs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tools.dapr.io,resources=daprs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tools.dapr.io,resources=daprs/finalizers,verbs=update
