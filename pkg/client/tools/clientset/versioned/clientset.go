...
import (
	...
	toolsv1alpha1 "github.com/lburgazzoli/dapr-operator-ng/pkg/client/tools/clientset/versioned/typed/tools/v1alpha1"
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.toolsV1alpha1, err = toolsv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
